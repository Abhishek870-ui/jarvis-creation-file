#schreen shot function
# this function help to store scrrenshot
#for we have o install pyautogui "pip install pyautogui"
...
def screenshot():
    ...
    img.save("E:\coding projects\python codes\jarvis")
